            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-2 overflow-x-auto pb-2">
                <button
                  ...
                  className={`px-5 py-2.5 min-w-[60px] w-auto h-auto inline-flex items-center justify-center text-[10px] font-black uppercase transition-all whitespace-nowrap border ${
