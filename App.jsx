...
export default function App() {
    ...
    return (
      <div className={`min-h-screen ${isDarkMode 
        ...
        <div className="relative z-10 w-full max-w-md">
          ...
          {/* Version */}
          <div className="text-center">
            <p className={`${isDarkMode ? 'text-white/30' : 'text-gray-400'} text-[9px] font-bold`}>VERSION 2.0.0</p>
            <p className={`${isDarkMode ? 'text-white/30' : 'text-gray-400'} text-[8px] mt-1`}>© 2025 SALES MONARCH. All rights reserved.</p>
          </div>
      ...
      <div className={`min-h-screen ${isDarkMode 
        ...
        <div className={`w-full max-w-sm ${isDarkMode 
          ...
          <div className="text-center mb-6">
            ...
            <h2 className={`${isDarkMode ? 'text-white' : 'text-gray-800'} font-black text-xl`}>Reset Password</h2>
            <p className={`${isDarkMode ? 'text-white/50' : 'text-gray-600'} text-xs mt-2`}>Enter your email to receive reset link</p>
          </div>
          ...
          {resetSuccess ? (
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                className={`w-full py-2 ${isDarkMode ? 'text-white/60 hover:text-white' : 'text-gray-600 hover:text-gray-800'} text-sm transition-all font-medium`}
              >
                ← Back to Login
              </button>
            </div>
          ...
          <form onSubmit={handleAuth} className="space-y-4">
            ...
            {loginError && (
              <div className={`p-3 ${isDarkMode 
                ...
                <p className={`${isDarkMode ? 'text-red-500' : 'text-red-700'} text-xs text-center font-bold`}>{loginError}</p>
              </div>
            )}
            ...
            <div className="flex justify-between items-center pt-2">
              ...
              {!isRegisterMode && (
                <button
                  ...
                  className={`${isDarkMode ? 'text-white/60 hover:text-white' : 'text-gray-600 hover:text-gray-800'} text-xs font-medium transition-all`}
                >
                  Forgot?
                </button>
              )}
  ...
  return (
    <div className={`min-h-screen pb-16 ${
      ...
      {/* Offline Indicator */}
      {isOffline && (
        <div className={`fixed top-14 left-1/2 transform -translate-x-1/2 z-[90] px-3 py-1 ${
          isDarkMode 
            ? 'bg-yellow-500/20 text-yellow-500 border-yellow-500/30' 
            : 'bg-yellow-50 text-yellow-700 border-yellow-200'
        } rounded-full border text-[10px] font-bold flex items-center gap-1 shadow-lg`}>
          <WifiOff size={12} />
          OFFLINE
        </div>
      )}
      ...
      {showDeleteConfirm.show && (
        <div className="fixed inset-0 bg-black/50 dark:bg-black/95 z-[1000] flex items-center justify-center p-4">
          <div className={`${isDarkMode 
            ? 'bg-gradient-to-br from-[#1a1a1a] to-[#000000] border-red-500/30' 
            : 'bg-white border-red-200'
          } w-full max-w-xs p-5 rounded-2xl border shadow-xl`}>
            <div className="text-center mb-4">
              <div className={`w-16 h-16 ${isDarkMode 
                ? 'bg-red-500/20 border-red-500/30' 
                : 'bg-red-50 border-red-200'
              } rounded-full flex items-center justify-center mx-auto mb-3 border`}>
                <Trash2 size={30} className={`${isDarkMode ? 'text-red-500' : 'text-red-600'}`} />
              </div>
              <h3 className={`${isDarkMode ? 'text-white' : 'text-gray-800'} font-black text-base`}>Confirm Delete</h3>
              <p className={`${isDarkMode ? 'text-white/60' : 'text-gray-600'} text-xs mt-2 font-medium`}>{showDeleteConfirm.name}</p>
              <p className={`${isDarkMode ? 'text-red-500' : 'text-red-600'} text-[10px] font-bold mt-3`}>This cannot be undone!</p>
            </div>
            <div className="flex gap-2">
              ...
              <button
                ...
                className={`flex-1 py-2 ${isDarkMode 
                  ? 'bg-gradient-to-br from-[#333] to-[#444] text-white/80' 
      ...
      {viewingShopOrders && (
        <div className="fixed inset-0 bg-black/50 dark:bg-black/95 z-[200] flex items-center justify-center p-3 overflow-y-auto">
          <div className={`w-full max-w-md ${isDarkMode 
            ...
            <p className={`${isDarkMode ? 'text-white' : 'text-gray-800'} font-black text-sm mb-1`}>{viewingShopOrders.shop.name}</p>
            <p className={`${isDarkMode ? 'text-white/40' : 'text-gray-500'} text-[10px] font-medium mb-4`}>{viewingShopOrders.shop.area}</p>
                ...
                <div key={idx} className={`${isDarkMode 
                  ...
                  <div className="flex gap-1 mt-1">
                    ...
                    <button
                      ...
                      } px-2 py-1 rounded transition-all font-black flex items-center gap-1`}
                    >
                      <MapPin size={8}/> Loc
                    </button>
                    <button
      ...
      {viewingShopProfile && (
        <div className="fixed inset-0 bg-black/50 dark:bg-black/95 z-[150] flex items-center justify-center p-3">
          <div className={`w-full max-w-xs ${isDarkMode 
            ...
            <p className={`${isDarkMode ? 'text-white' : 'text-gray-800'} font-black text-sm mb-3`}>{viewingShopProfile.shop.name}</p>
            ...
            {viewingShopProfile.profile ? (
              ...
              <p className={`${isDarkMode ? 'text-white/60' : 'text-gray-600'} text-xs text-center py-4 font-medium`}>No profile found</p>
            )}
          </div>
        </div>
      )}
        ...
        <div className="flex gap-1">
          ...
          <button
            ...
            className={`p-1.5 ${isDarkMode 
              ...
              : 'bg-red-50 text-red-700 border-red-200'
            } rounded-lg border hover:bg-red-500/20 transition-all`}
          >
            <LogOut size={16}/>
          </button>
        </div>
              ...
              <div className={`flex-1 p-2 rounded-xl border flex items-center gap-2 ${
                ...
                <input
                  ...
                  className={`bg-transparent text-[10px] font-bold uppercase outline-none w-full ${
                    isDarkMode ? 'text-white placeholder-white/30' : 'text-gray-800 placeholder-gray-400'
                  }`}
                />
              </div>
              <button
              ...
              <div key={o.id} className={`p-3 rounded-xl border ${
                ...
                <div className="flex justify-between items-start mb-2">
                  ...
                  <div className="flex gap-1">
                    ...
                    <button onClick={() => confirmDelete(o.id, 'order', '')} className={`p-1 ${isDarkMode ? 'text-red-500 hover:bg-red-500/10' : 'text-red-600 hover:bg-red-50'} rounded transition-all`}>
                      <Trash2 size={12}/>
                    </button>
                  </div>
                </div>
              ...
              <div key={o.id} className={`p-3 rounded-xl border ${
                ...
                <div className="flex justify-between items-start mb-2">
                  ...
                  <div className="flex gap-1">
                    ...
                    <button onClick={() => shareToWhatsApp(o, false)} className={`p-1 ${isDarkMode ? 'text-purple-500 hover:bg-purple-500/10' : 'text-purple-600 hover:bg-purple-50'} rounded transition-all`}>
                      <Share2 size={12}/>
                    </button>
                    <button onClick={() => confirmDelete(o.id, 'order', '')} className={`p-1 ${isDarkMode ? 'text-red-500 hover:bg-red-500/10' : 'text-red-600 hover:bg-red-50'} rounded transition-all`}>
                      <Trash2 size={12}/>
          ...
          <div className="space-y-3">
            ...
            {filteredNotes.map((note) => (
              <div key={note.id} className={`p-3 rounded-xl border ${
                ...
                <p className={`text-[10px] ${isDarkMode ? 'text-white' : 'text-gray-800'} font-medium`}>{note.text}</p>
              </div>
            ))}
          </div>
        )}
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex gap-1">
                        ...
                        <button
                          ...
                          className={`p-1.5 ${isDarkMode ? 'text-blue-500 hover:bg-blue-500/10' : 'text-blue-600 hover:bg-blue-50'} rounded-lg transition-all`}
                        >
                          <Edit2 size={12} />
                        </button>
                        <button
                          onClick={() => confirmDelete(b.id, 'brand', b.name)}
                          className={`p-1.5 ${isDarkMode ? 'text-red-500 hover:bg-red-500/10' : 'text-red-600 hover:bg-red-50'} rounded-lg transition-all`}
                        >
                          <Trash2 size={12} />
                        </button>
                      </div>
              ...
              <div className="space-y-1 max-h-24 overflow-y-auto text-[9px]">
                {lastOrder.items?.map((it, idx) => (
                  <div key={idx} className="flex justify-between">
                    <span className={`font-medium ${isDarkMode ? 'text-white' : 'text-gray-600'}`}>{it.name} x{it.qty}</span>
                    <span className={`font-black ${isDarkMode ? 'text-white' : 'text-gray-800'}`}>Rs.{it.subtotal}</span>
                  </div>
                ))}
              </div>
